...
export default function CheckStatusPage() {
  ...
  const checkStatus = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/check-registration?registrationNumber=${encodeURIComponent(formattedNumber)}&turnstileToken=${encodeURIComponent(turnstileToken)}`)
